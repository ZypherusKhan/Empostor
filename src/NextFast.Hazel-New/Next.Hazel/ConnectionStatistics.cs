...
public class ConnectionStatistics
{
    ...
    /// </summary>
    public int MessagesSent => UnreliableMessagesSent + ReliableMessagesSent + FragmentedMessagesSent +
                               AcknowledgementMessagesSent + HelloMessagesSent;
    ...
    /// </remarks>
    public int FragmentableMessagesSent => fragmentableMessagesSent;
    ...
    /// </summary>
    public int MessagesReceived => UnreliableMessagesReceived + ReliableMessagesReceived + FragmentedMessagesReceived +
                                   AcknowledgementMessagesReceived + helloMessagesReceived;
    ...
    ///     each time that LogUnreliableReceive is called by the Connection. Messages are counted before the receive event is
    ///     invoked.
    /// </remarks>
    ...
    ///     each time that LogReliableReceive is called by the Connection. Messages are counted before the receive event is
    ///     invoked.
    /// </remarks>
    ...
    ///     each time that LogFragmentedReceive is called by the Connection. Messages are counted before the receive event is
    ///     invoked.
    /// </remarks>
    ...
    ///     each time that LogAcknowledgemntReceive is called by the Connection. Messages are counted before the receive event
    ///     is invoked.
    /// </remarks>
    ...
    ///     each time that LogHelloReceive is called by the Connection. Messages are counted before the receive event is
    ///     invoked.
    /// </remarks>
    ...
    internal void LogUnreliableSend(int dataLength, int totalLength)
    {
        ...
        if (totalLength > ExpectedMTU) Interlocked.Increment(ref fragmentableMessagesSent);
    }
